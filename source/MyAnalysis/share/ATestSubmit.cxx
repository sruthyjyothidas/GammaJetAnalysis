...
void ATestSubmit (const std::string& submitDir)
{
  ...
  SH::scanRucio (sh, "data17_5TeV.00340718.physics_Main.merge.AOD.r11382_p3827_tid17838594_00/"); //pp Data  
  ...
  driver.options()->setString("nc_outputSampleName", "user.srdas.02172021.R1Jet.pp2017HI.0000"); 
